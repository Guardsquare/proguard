...
class ObfuscatorDiffblueTest {
   ...
   *
   * <p>Method under test: {@link Obfuscator#Obfuscator(Configuration)}
   */
  @Test
  ...
  void testNewObfuscator() throws MalformedURLException {
    ...
    // Act and Assert
    assertEquals("proguard.obfuscate.Obfuscator", new Obfuscator(configuration).getName());
  }

  /**
   * Test {@link Obfuscator#execute(AppView)}.
   *
   * <p>Method under test: {@link Obfuscator#execute(AppView)}
   */
  @Test
  @DisplayName("Test execute(AppView)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void Obfuscator.execute(AppView)"})
  void testExecute() throws IOException {
    ...
    configuration.mergeInterfacesAggressively = true;
    configuration.microEdition = true;
    configuration.newSourceFileAttribute = "Obfuscating...";
    configuration.note = new ArrayList<>();
    configuration.obfuscate = true;
    configuration.obfuscationDictionary =
        Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toUri().toURL();
    ...
    doNothing().when(programClassPool).classesAcceptAlphabetically(Mockito.<ClassVisitor>any());
    doNothing().when(programClassPool).classesAccept(Mockito.<ClassVisitor>any());

    ClassPool libraryClassPool = mock(ClassPool.class);
    LibraryClass libraryClass = new LibraryClass(1, "Obfuscating...", "Obfuscating...");
    ...
    verify(programClassPool).classesAcceptAlphabetically(isA(ClassVisitor.class));
  ...
  void testExecute2() throws IOException {
    ...
    when(libraryClassPool.getClass(Mockito.<String>any()))
        .thenReturn(
  ...
  void testExecute3() throws IOException {
    ...
    ClassPool libraryClassPool = mock(ClassPool.class);
    ClassConstant classConstant = new ClassConstant();
    LibraryClass referencedClass = new LibraryClass(1, "Obfuscating...", "Obfuscating...");
    ClassConstant classConstant2 = new ClassConstant(1, referencedClass);
    when(libraryClassPool.getClass(Mockito.<String>any()))
        .thenReturn(
  ...
  void testExecute4() throws IOException {
    ...
    ClassPool libraryClassPool = mock(ClassPool.class);
    ClassConstant classConstant = new ClassConstant();
    ClassConstant classConstant2 = new ClassConstant(1, new ProgramClass());
    when(libraryClassPool.getClass(Mockito.<String>any()))
        .thenReturn(
            new ProgramClass(1, 3, new Constant[] {classConstant, classConstant2}, 1, 1, 1));
    doNothing().when(libraryClassPool).classesAccept(Mockito.<ClassVisitor>any());
   ...
   *       Configuration#allowAccessModification} is {@code false}.
   * </ul>
   *
   * <p>Method under test: {@link Obfuscator#execute(AppView)}
   */
  @Test
  @DisplayName(
      "Test execute(AppView); given Configuration (default constructor) allowAccessModification is 'false'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void Obfuscator.execute(AppView)"})
  void testExecute_givenConfigurationAllowAccessModificationIsFalse() throws IOException {
    // Arrange
    Configuration configuration = new Configuration();
    configuration.adaptClassStrings = new ArrayList<>();
    configuration.adaptResourceFileContents = new ArrayList<>();
    ...
    verify(programClassPool, atLeast(1)).getClass(Mockito.<String>any());
    verify(libraryClassPool, atLeast(1)).getClass(Mockito.<String>any());
    verify(referencedClass, atLeast(1))
  ...
  @Test
  @DisplayName(
      "Test execute(AppView); given Configuration (default constructor) flattenPackageHierarchy is empty string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void Obfuscator.execute(AppView)"})
  void testExecute_givenConfigurationFlattenPackageHierarchyIsEmptyString() throws IOException {
    // Arrange
    Configuration configuration = new Configuration();
    configuration.adaptClassStrings = new ArrayList<>();
    configuration.adaptResourceFileContents = new ArrayList<>();
   ...
   * <ul>
   *   <li>Given {@link Configuration} (default constructor) {@link
   *       Configuration#keepKotlinMetadata} is {@code false}.
  ...
  @Test
  @DisplayName(
      "Test execute(AppView); given Configuration (default constructor) keepKotlinMetadata is 'false'; then calls hierarchyAccept(boolean, boolean, boolean, boolean, ClassVisitor)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void Obfuscator.execute(AppView)"})
  void testExecute_givenConfigurationKeepKotlinMetadataIsFalse_thenCallsHierarchyAccept()
      throws IOException {
    // Arrange
    Configuration configuration = new Configuration();
    configuration.adaptClassStrings = new ArrayList<>();
