...
/**
 * Test class for {@link KotlinPropertyNameObfuscator} constructor.
 * Tests the single-parameter constructor:
 * <init>.(Lproguard/obfuscate/NameFactory;)V
 */
public class KotlinPropertyNameObfuscatorClaude_constructorTest {

    /**
     * Tests the constructor with a valid NameFactory parameter.
     * Verifies that a KotlinPropertyNameObfuscator can be instantiated with a valid parameter.
     */
    @Test
    public void testConstructorWithValidNameFactory() {
        ...
        // Act
        KotlinPropertyNameObfuscator obfuscator = new KotlinPropertyNameObfuscator(nameFactory);

        // Assert
        assertNotNull(obfuscator, "KotlinPropertyNameObfuscator should be created successfully");
    }
    ...
    public void testConstructorWithSimpleNameFactory() {
        ...
        // Assert
        assertNotNull(obfuscator, "KotlinPropertyNameObfuscator should be created with SimpleNameFactory");
    }
    ...
    public void testConstructorWithMixedCaseNameFactory() {
        ...
        // Assert
        assertNotNull(obfuscator, "KotlinPropertyNameObfuscator should be created with mixed-case name factory");
    }
    ...
    public void testConstructorWithLowerCaseNameFactory() {
        ...
        // Assert
        assertNotNull(obfuscator, "KotlinPropertyNameObfuscator should be created with lower-case name factory");
    }
    ...
    public void testConstructorCreatesDifferentInstances() {
        ...
        // Act
        KotlinPropertyNameObfuscator obfuscator1 = new KotlinPropertyNameObfuscator(nameFactory);
    ...
    public void testObfuscatorImplementsKotlinMetadataVisitor() {
        ...
        assertTrue(obfuscator instanceof KotlinMetadataVisitor,
                   "KotlinPropertyNameObfuscator should implement KotlinMetadataVisitor");
    }

    /**
     * Tests that the obfuscator implements KotlinPropertyVisitor interface.
     * Verifies that it can be used as a KotlinPropertyVisitor.
     */
    @Test
    public void testObfuscatorImplementsKotlinPropertyVisitor() {
        // Arrange
        NameFactory nameFactory = mock(NameFactory.class);
        ...
        // Assert
        assertTrue(obfuscator instanceof KotlinPropertyVisitor,
                   "KotlinPropertyNameObfuscator should implement KotlinPropertyVisitor");
    }
    ...
    public void testMultipleObfuscatorsWithSameNameFactory() {
        ...
        // Act
        KotlinPropertyNameObfuscator obfuscator1 = new KotlinPropertyNameObfuscator(sharedFactory);
    ...
    public void testObfuscatorAsKotlinMetadataVisitor() {
        ...
        // Act
        KotlinMetadataVisitor obfuscator = new KotlinPropertyNameObfuscator(nameFactory);

        // Assert
        assertNotNull(obfuscator, "KotlinPropertyNameObfuscator should be assignable to KotlinMetadataVisitor");
    }

    /**
     * Tests that the obfuscator can be assigned to KotlinPropertyVisitor reference.
     * Verifies interface implementation.
     */
    @Test
    public void testObfuscatorAsKotlinPropertyVisitor() {
        // Arrange
        NameFactory nameFactory = mock(NameFactory.class);

        // Act
        KotlinPropertyVisitor obfuscator = new KotlinPropertyNameObfuscator(nameFactory);

        // Assert
        assertNotNull(obfuscator, "KotlinPropertyNameObfuscator should be assignable to KotlinPropertyVisitor");
    }
    ...
    public void testMultipleSequentialConstructorCalls() {
        ...
        // Act & Assert
        for (int i = 0; i < 10; i++) {
            KotlinPropertyNameObfuscator obfuscator = new KotlinPropertyNameObfuscator(factory);
    ...
    public void testConstructorWithCustomNameFactory() {
        ...
        // Act
        KotlinPropertyNameObfuscator obfuscator = new KotlinPropertyNameObfuscator(customFactory);

        // Assert
        assertNotNull(obfuscator, "KotlinPropertyNameObfuscator should be created with custom factory");
    }
    ...
    public void testConcurrentConstructorCalls() {
        ...
        KotlinPropertyNameObfuscator obfuscator1 = new KotlinPropertyNameObfuscator(factory1);
        KotlinPropertyNameObfuscator obfuscator2 = new KotlinPropertyNameObfuscator(factory2);
        KotlinPropertyNameObfuscator obfuscator3 = new KotlinPropertyNameObfuscator(factory3);
