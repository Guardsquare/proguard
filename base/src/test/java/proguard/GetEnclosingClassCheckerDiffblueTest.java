...
class GetEnclosingClassCheckerDiffblueTest {
  ...
  void testVisitMethodrefConstant() {
    ...
    GetEnclosingClassChecker getEnclosingClassChecker = new GetEnclosingClassChecker(notePrinter);
  ...
  void testVisitMethodrefConstant_givenWarningLoggerPrintDoesNothing_thenCallsPrint() {
    ...
    verify(clazz, atLeast(1)).getName();
    verify(clazz).getName(0);
    verify(notePrinter).print("Name", "Note: Name calls 'Class.getEnclosingClass'");
  }
  ...
  void testVisitMethodrefConstant_givenWarningLoggerWithLoggerIsExtendedLoggerWrapper() {
    ...
    GetEnclosingClassChecker getEnclosingClassChecker =
        new GetEnclosingClassChecker(new WarningLogger(logger2));
