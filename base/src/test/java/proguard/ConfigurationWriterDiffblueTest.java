...
class ConfigurationWriterDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link ConfigurationConstants#ARGUMENT_SEPARATOR_KEYWORD}.
   * </ul>
   *
   * <p>Method under test: {@link ConfigurationWriter#write(Configuration)}
   */
  @Test
  @DisplayName("Test write(Configuration); given ARGUMENT_SEPARATOR_KEYWORD")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void ConfigurationWriter.write(Configuration)"})
  void testWrite_givenArgument_separator_keyword() throws IOException {
    // Arrange
    ConfigurationWriter configurationWriter = new ConfigurationWriter(Configuration.STD_OUT);
    ...
    configuration.enableKotlinAsserter = true;
    configuration.extraJar = Configuration.STD_OUT;
    configuration.flattenPackageHierarchy = ConfigurationConstants.ARGUMENT_SEPARATOR_KEYWORD;
    configuration.ignoreWarnings = true;
    configuration.keep = new ArrayList<>();
    configuration.keepAttributes = new ArrayList<>();
    configuration.keepDirectories = new ArrayList();
   ...
   *
   * <ul>
   *   <li>Given {@link ConfigurationConstants#JAR_SEPARATOR_KEYWORD}.
   * </ul>
   *
   * <p>Method under test: {@link ConfigurationWriter#write(Configuration)}
   */
  @Test
  @DisplayName("Test write(Configuration); given JAR_SEPARATOR_KEYWORD")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void ConfigurationWriter.write(Configuration)"})
  void testWrite_givenJar_separator_keyword() throws IOException {
    // Arrange
    ConfigurationWriter configurationWriter = new ConfigurationWriter(Configuration.STD_OUT);
    ...
    configuration.enableKotlinAsserter = true;
    configuration.extraJar = Configuration.STD_OUT;
    configuration.flattenPackageHierarchy = ConfigurationConstants.JAR_SEPARATOR_KEYWORD;
    configuration.ignoreWarnings = true;
    configuration.keep = new ArrayList<>();
    configuration.keepAttributes = new ArrayList<>();
    configuration.keepDirectories = new ArrayList();
