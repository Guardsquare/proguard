...
class InputReaderDiffblueTest {
  ...
  void testReadInputWithMessagePrefixClassPathFromIndexToIndexReader7() throws IOException {
    ...
    ClassPathEntry classPathEntry =
        new ClassPathEntry(
            Paths.get(System.getProperty("java.io.tmpdir"), "{}{} [{}]{}").toFile(), false);
    classPathEntry.setFilter(filter);
  ...
  void testReadInputWithMessagePrefixClassPathFromIndexToIndexReader8() throws IOException {
    ...
    ClassPathEntry classPathEntry =
        new ClassPathEntry(Paths.get(System.getProperty("java.io.tmpdir"), "foo").toFile(), false);
    classPathEntry.setFilter(filter);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void InputReader.readInput(String, ClassPath, int, int, DataEntryReader)"})
  void testReadInputWithMessagePrefixClassPathFromIndexToIndexReader9() throws IOException {
    // Arrange
    InputReader inputReader = new InputReader(mock(Configuration.class));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void InputReader.readInput(String, ClassPath, int, int, DataEntryReader)"})
  void testReadInputWithMessagePrefixClassPathFromIndexToIndexReader10() throws IOException {
    // Arrange
    InputReader inputReader = new InputReader(mock(Configuration.class));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void InputReader.readInput(String, ClassPath, int, int, DataEntryReader)"})
  void testReadInputWithMessagePrefixClassPathFromIndexToIndexReader11() throws IOException {
    // Arrange
    InputReader inputReader = new InputReader(mock(Configuration.class));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void InputReader.readInput(String, ClassPath, int, int, DataEntryReader)"})
  void testReadInputWithMessagePrefixClassPathFromIndexToIndexReader12() throws IOException {
    // Arrange
    InputReader inputReader = new InputReader(mock(Configuration.class));
  ...
  @Test
  @DisplayName(
      "Test readInput(String, ClassPath, int, int, DataEntryReader) with 'messagePrefix', 'classPath', 'fromIndex', 'toIndex', 'reader'; given IOException()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void InputReader.readInput(String, ClassPath, int, int, DataEntryReader)"})
  void testReadInputWithMessagePrefixClassPathFromIndexToIndexReader_givenIOException()
      throws IOException {
    // Arrange
    InputReader inputReader = new InputReader(mock(Configuration.class));
  ...
  @Test
  @DisplayName(
      "Test readInput(String, ClassPath, int, int, DataEntryReader) with 'messagePrefix', 'classPath', 'fromIndex', 'toIndex', 'reader'; when ClassPath (default constructor)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void InputReader.readInput(String, ClassPath, int, int, DataEntryReader)"})
  void testReadInputWithMessagePrefixClassPathFromIndexToIndexReader_whenClassPath()
      throws IOException {
    // Arrange
    InputReader inputReader = new InputReader(mock(Configuration.class));
