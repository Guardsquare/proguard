...
/**
 * Test class for {@link StreamSupportConverter}.
 ...
 */
public class StreamSupportConverterClaudeTest {

    /**
     * Tests the constructor with all valid non-null parameters.
     * Verifies that a StreamSupportConverter can be instantiated with valid parameters.
     */
    @Test
    public void testConstructorWithAllValidParameters() {
        ...
        // Act
        StreamSupportConverter converter = new StreamSupportConverter(
            programClassPool,
            libraryClassPool,
            warningPrinter,
        ...
        // Assert
        assertNotNull(converter, "StreamSupportConverter should be created successfully");
    }
    ...
    public void testConstructorWithNullModifiedClassVisitor() {
        ...
        // Assert
        assertNotNull(converter, "StreamSupportConverter should be created with null modifiedClassVisitor");
    }
    ...
    public void testConstructorWithNullExtraInstructionVisitor() {
        ...
        // Assert
        assertNotNull(converter, "StreamSupportConverter should be created with null extraInstructionVisitor");
    }
    ...
    public void testConstructorWithBothOptionalVisitorsNull() {
        ...
        // Assert
        assertNotNull(converter, "StreamSupportConverter should be created with both optional visitors null");
    }
    ...
    public void testConstructorWithEmptyClassPools() {
        ...
        // Assert
        assertNotNull(converter, "StreamSupportConverter should be created with empty class pools");
    }

    /**
     * Tests that multiple instances of StreamSupportConverter can be created independently.
    ...
    public void testMultipleConverterInstances() {
        ...
        // Act
        StreamSupportConverter converter1 = new StreamSupportConverter(
            programClassPool1,
            libraryClassPool1,
            warningPrinter1,
            modifiedClassVisitor,
        ...
        StreamSupportConverter converter2 = new StreamSupportConverter(
            programClassPool2,
            libraryClassPool2,
            warningPrinter2,
            modifiedClassVisitor,
    ...
    public void testConverterExtendsAbstractAPIConverter() {
        ...
        assertTrue(converter instanceof AbstractAPIConverter,
                   "StreamSupportConverter should extend AbstractAPIConverter");
    }
    ...
    public void testConverterImplementsClassVisitor() {
        ...
        assertTrue(converter instanceof ClassVisitor,
                   "StreamSupportConverter should implement ClassVisitor");
    }
    ...
    public void testConstructorWithOnlyRequiredParameters() {
        ...
        // Assert
        assertNotNull(converter, "StreamSupportConverter should be created with only required parameters");
    }
    ...
    public void testConverterAsAbstractAPIConverter() {
        ...
        // Act
        AbstractAPIConverter converter = new StreamSupportConverter(
            programClassPool,
            libraryClassPool,
            warningPrinter,
            null,
        ...
        // Assert
        assertNotNull(converter, "StreamSupportConverter should be assignable to AbstractAPIConverter");
    }
    ...
    public void testConverterAsClassVisitor() {
        ...
        // Act
        ClassVisitor converter = new StreamSupportConverter(
            programClassPool,
            libraryClassPool,
            warningPrinter,
            null,
        ...
        // Assert
        assertNotNull(converter, "StreamSupportConverter should be assignable to ClassVisitor");
    }
}
