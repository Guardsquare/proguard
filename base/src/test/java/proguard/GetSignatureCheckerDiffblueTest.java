...
class GetSignatureCheckerDiffblueTest {
   ...
   *
   * <p>Method under test: {@link GetSignatureChecker#visitMethodrefConstant(Clazz,
   * MethodrefConstant)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void GetSignatureChecker.visitMethodrefConstant(Clazz, MethodrefConstant)"})
  void testVisitMethodrefConstant() {
    ...
    GetSignatureChecker getSignatureChecker = new GetSignatureChecker(notePrinter);
  ...
  void testVisitMethodrefConstant_givenWarningLoggerPrintDoesNothing_thenCallsPrint() {
    ...
    verify(clazz, atLeast(1)).getName();
    verify(clazz).getName(0);
    verify(notePrinter).print("Name", "Note: Name calls 'Class.getType'");
  }
  ...
  void testVisitMethodrefConstant_givenWarningLoggerWithLoggerIsExtendedLoggerWrapper() {
    ...
    ExtendedLoggerWrapper logger2 =
        new ExtendedLoggerWrapper(logger, "Name", new FormattedMessageFactory());
    GetSignatureChecker getSignatureChecker = new GetSignatureChecker(new WarningLogger(logger2));
