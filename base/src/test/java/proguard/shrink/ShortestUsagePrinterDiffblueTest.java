...
class ShortestUsagePrinterDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test visitProgramMethod(ProgramClass, ProgramMethod); given Clazz accept(ClassVisitor) does nothing; then calls accept(ClassVisitor)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void ShortestUsagePrinter.visitProgramMethod(ProgramClass, ProgramMethod)"})
  ...
  @Test
  @DisplayName(
      "Test visitProgramMethod(ProgramClass, ProgramMethod); given UnsupportedOperationException()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void ShortestUsagePrinter.visitProgramMethod(ProgramClass, ProgramMethod)"})
  void testVisitProgramMethod_givenUnsupportedOperationException() {
    // Arrange
    ShortestUsageMarker shortestUsageMarker = new ShortestUsageMarker();
    ShortestUsagePrinter shortestUsagePrinter =
        new ShortestUsagePrinter(shortestUsageMarker, false, new PrintWriter(new StringWriter()));
