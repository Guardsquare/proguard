...
class TargetClassChangerDiffblueTest {
  ...
  void testVisitSignatureAttributeWithClazzSignatureAttribute3() {
    ...
    ClassOptimizationInfo classOptimizationInfo = mock(ClassOptimizationInfo.class);
    when(classOptimizationInfo.getTargetClass()).thenThrow(new UnsupportedOperationException());
  ...
  @Test
  @DisplayName(
      "Test visitSignatureAttribute(Clazz, SignatureAttribute) with 'clazz', 'signatureAttribute'; given array of Clazz with 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TargetClassChanger.visitSignatureAttribute(Clazz, SignatureAttribute)"})
  void testVisitSignatureAttributeWithClazzSignatureAttribute_givenArrayOfClazzWithNull() {
    // Arrange
    TargetClassChanger targetClassChanger = new TargetClassChanger();
    LibraryClass clazz = mock(LibraryClass.class);
    SignatureAttribute signatureAttribute = new SignatureAttribute(1, 1);
    signatureAttribute.referencedClasses = new Clazz[] {null};

    // Act and Assert
    assertDoesNotThrow(() -> targetClassChanger.visitSignatureAttribute(clazz, signatureAttribute));
  }
   ...
   *
   * <ul>
   *   <li>When {@link SignatureAttribute#SignatureAttribute()}.
   * </ul>
   *
   * <p>Method under test: {@link TargetClassChanger#visitSignatureAttribute(Clazz,
   * SignatureAttribute)}
  ...
  @Test
  @DisplayName(
      "Test visitSignatureAttribute(Clazz, SignatureAttribute) with 'clazz', 'signatureAttribute'; when SignatureAttribute()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TargetClassChanger.visitSignatureAttribute(Clazz, SignatureAttribute)"})
  void testVisitSignatureAttributeWithClazzSignatureAttribute_whenSignatureAttribute() {
    // Arrange
    TargetClassChanger targetClassChanger = new TargetClassChanger();
    LibraryClass clazz = new LibraryClass();
    ...
    // Act and Assert
    assertDoesNotThrow(
        () -> targetClassChanger.visitSignatureAttribute(clazz, new SignatureAttribute()));
  }
