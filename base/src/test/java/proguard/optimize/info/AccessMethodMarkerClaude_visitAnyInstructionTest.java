...
/**
 * Test class for {@link AccessMethodMarker#visitAnyInstruction(Clazz, Method, CodeAttribute, int, Instruction)}.
 *
 * The visitAnyInstruction method is an empty implementation (no-op) that serves as a default
 * handler in the InstructionVisitor pattern. The AccessMethodMarker only processes
 ...
 */
public class AccessMethodMarkerClaude_visitAnyInstructionTest {
    ...
    /**
     * Tests that visitAnyInstruction doesn't affect the marker's invokingMethod field.
     * Since it's a no-op, it should not set or use the invokingMethod field.
     */
    @Test
