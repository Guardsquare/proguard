...
/**
 * Test class for {@link OptimizedJsonWriterImplInitializer}.
 * Tests the constructor, visitAnyAttribute, and visitCodeAttribute methods.
 *
 * The OptimizedJsonWriterImplInitializer class implements the static initializer
 * of _OptimizedJsonWriterImpl to initialize the data structure with the correct
 * mapping between internal indices and Json field names (as a String array).
 */
public class OptimizedJsonWriterImplInitializerClaudeTest {
    ...
    /**
     * Tests that the constructor creates a non-null OptimizedJsonWriterImplInitializer instance
    ...
    public void testConstructor_withValidParameters_createsNonNullInstance() {
        ...
        // Act
        OptimizedJsonWriterImplInitializer initializer = new OptimizedJsonWriterImplInitializer(
            programClassPool,
            libraryClassPool,
            codeAttributeEditor,
            serializationInfo
        ...
        // Assert
        assertNotNull(initializer, "OptimizedJsonWriterImplInitializer instance should not be null");
    }
    ...
    public void testConstructor_withNullProgramClassPool_doesNotThrow() {
        ...
        // Act & Assert
        assertDoesNotThrow(() -> new OptimizedJsonWriterImplInitializer(
            null,
            libraryClassPool,
            codeAttributeEditor,
            serializationInfo
    ...
    /**
     * Tests that the constructor accepts null serialization info.
     */
    @Test
    public void testConstructor_withNullSerializationInfo_doesNotThrow() {
        // Arrange
        CodeAttributeEditor codeAttributeEditor = mock(CodeAttributeEditor.class);
        ...
        assertDoesNotThrow(() -> new OptimizedJsonWriterImplInitializer(
            ...
            codeAttributeEditor,
            null
        ), "Constructor should accept null serialization info");
    }
    ...
    public void testConstructor_multipleInstances_areIndependent() {
        ...
        // Act
        OptimizedJsonWriterImplInitializer initializer1 = new OptimizedJsonWriterImplInitializer(
            programClassPool,
            libraryClassPool,
        ...
        OptimizedJsonWriterImplInitializer initializer2 = new OptimizedJsonWriterImplInitializer(
            programClassPool,
            libraryClassPool,
    ...
    /**
     * Tests that visitCodeAttribute throws NullPointerException with null serialization info.
     * With null serialization info, the method should fail when trying to access jsonFieldIndices.
     */
    @Test
    public void testVisitCodeAttribute_withNullSerializationInfo_throwsNullPointerException() {
        // Arrange
        CodeAttributeEditor codeAttributeEditor = mock(CodeAttributeEditor.class);
        OptimizedJsonWriterImplInitializer initializer = new OptimizedJsonWriterImplInitializer(
            programClassPool,
        ...
        assertThrows(NullPointerException.class,
            ...
            "Should throw NullPointerException when serialization info is null");
    }

    /**
     * Tests that visitCodeAttribute requires String class in library pool.
     * The method tries to look up String from the library class pool, which will be null if not present.
    ...
    public void testVisitCodeAttribute_withEmptyLibraryPool_throwsNullPointerException() {
        ...
        // but it still tries to create a String array before the loop

        OptimizedJsonWriterImplInitializer initializer = new OptimizedJsonWriterImplInitializer(
            programClassPool,
            libraryClassPool, // empty pool, doesn't have String
            codeAttributeEditor,
            emptyInfo
        );
        ...
        // Act & Assert
        // The method will fail when trying to get String from the empty library pool
        assertThrows(NullPointerException.class,
            () -> initializer.visitCodeAttribute(programClass, method, codeAttribute),
    ...
    /**
     * Tests that visitCodeAttribute throws exception with null clazz parameter.
    ...
    /**
     * Tests that visitCodeAttribute with null method throws due to empty library pool.
     * The method parameter is passed to codeAttributeEditor.visitCodeAttribute
     * but is not used directly in the initializer logic until later.
     * It will fail earlier when trying to get String from the empty library pool.
     */
    @Test
    public void testVisitCodeAttribute_withNullMethod_throwsDueToEmptyLibraryPool() {
        ...
        // Act & Assert
        // The method parameter is passed to codeAttributeEditor.visitCodeAttribute
        // but is not used directly in the initializer logic until line 104
        // It will fail earlier when trying to get String from the empty library pool
        assertThrows(NullPointerException.class,
     ...
     * The implementation casts clazz to ProgramClass on line 82.
     */
    @Test
     ...
     * Even with a ProgramClass, the method needs String class in the library pool.
     */
    @Test
    public void testVisitCodeAttribute_withProgramClass_requiresStringInLibraryPool() {
        // Arrange
        CodeAttributeEditor codeAttributeEditor = mock(CodeAttributeEditor.class);
        OptimizedJsonWriterImplInitializer initializer = new OptimizedJsonWriterImplInitializer(
            programClassPool,
            libraryClassPool, // empty, doesn't have String
            codeAttributeEditor,
            serializationInfo
        );
        ProgramClass programClass = new ProgramClass();
        ...
        assertThrows(NullPointerException.class,
            () -> initializer.visitCodeAttribute(programClass, method, codeAttribute),
            "visitCodeAttribute requires String class in library pool"
        );
    }
    ...
    /**
     * Tests that visitCodeAttribute accesses the jsonFieldIndices map from serializationInfo.
     * This test verifies that the serializationInfo parameter is actually used.
     */
    @Test
    public void testVisitCodeAttribute_accessesJsonFieldIndicesFromSerializationInfo() {
        // Arrange
        CodeAttributeEditor codeAttributeEditor = mock(CodeAttributeEditor.class);
        ...
        // because the library pool is empty and doesn't have String
        assertThrows(NullPointerException.class,
            () -> initializer.visitCodeAttribute(programClass, method, codeAttribute),
