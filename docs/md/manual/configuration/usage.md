...
!!! android R8
    ...
    [DexGuard](https://www.guardsquare.com/dexguard) is a protection tool for Android apps that is backward compatible with R8, making it easy to upgrade your R8 configuration with multi-layered security protections to your unprotected mobile application. Learn more in our blog: [Android Security and Obfuscation Realities of R8](https://www.guardsquare.com/blog/android-security-and-obfuscation-realities-of-r8).
