...
class LinearTimingDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link LinearTiming#LinearTiming(long, long)} with fromTime is one and toTime is
   *       one.
   *   <li>Then return one.
   * </ul>
   *
   * <p>Method under test: {@link LinearTiming#getTiming(long)}
   */
  @Test
  @DisplayName(
      "Test getTiming(long); given LinearTiming(long, long) with fromTime is one and toTime is one; then return one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
   ...
   *
   * <ul>
   *   <li>Given {@link LinearTiming#LinearTiming(long, long)} with fromTime is ten and toTime is
   *       one.
   *   <li>Then return zero.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test getTiming(long); given LinearTiming(long, long) with fromTime is ten and toTime is one; then return zero")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double LinearTiming.getTiming(long)"})
   ...
   *
   * <ul>
   *   <li>Then return {@code 9.75781955236954E-19}.
   * </ul>
   *
   * <p>Method under test: {@link LinearTiming#getTiming(long)}
   */
