...
class SmoothTimingDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link SmoothTiming#SmoothTiming(long, long)} with fromTime is one and toTime is
   *       one.
   *   <li>Then return one.
   * </ul>
   *
   * <p>Method under test: {@link SmoothTiming#getTiming(long)}
   */
  @Test
  @DisplayName(
      "Test getTiming(long); given SmoothTiming(long, long) with fromTime is one and toTime is one; then return one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
   ...
   *
   * <ul>
   *   <li>Given {@link SmoothTiming#SmoothTiming(long, long)} with fromTime is ten and toTime is
   *       one.
   *   <li>Then return zero.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test getTiming(long); given SmoothTiming(long, long) with fromTime is ten and toTime is one; then return zero")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double SmoothTiming.getTiming(long)"})
   ...
   *
   * <ul>
   *   <li>Then return {@code 2.8564512724981586E-36}.
   * </ul>
   *
   * <p>Method under test: {@link SmoothTiming#getTiming(long)}
   */
